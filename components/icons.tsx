...
const WritingIcon = () => {
  return (
    <svg className="h-4 w-4" viewBox="0 0 36 36">
      <path
        fill="#EF9645"
        d="M6.203 21.641c-.078.922.321 1.198.946 1.636c.618.433 4.383-2.867 5.614-3.369c1.231-.502 12.787-2.949 12.286-5.183c-.501-2.234-3.993-2.564-6.683-2.108c-2.69.456-7.838 2.822-9.342 4.099c-1.504 1.276-2.821 4.925-2.821 4.925m8.622 1.497s-3.557 1.155-3.557 4.155s.866 4.692 1.276 5.513c.411.82 1.688 1.616 3.455.851c2.052-.889-.491-6.004 6-3.656c2.974 1.075 6.059 2.528 9.059 1.528C33.904 30.58 35 27 35 25c0-4.094-3-3-4-2s-9 3-10 3s-6.175-2.862-6.175-2.862"
      />
      <path
        fill="#F9CA55"
        d="M19.312 28.188s-.12-1.316-1.375-1.469c-1.031-.125-2.656.219-3.5 1.906c-.844 1.688-2.344 1.406-2.281 2.812c.062 1.406.5 2.5 1.406 2.781c.907.282 2.188-.218 2.344-1.718c.156-1.5.344-2.875 1.312-3.469c.97-.593 2.094-.843 2.094-.843"
      />
      <path fill="#EF9645" d="M18 26s-1-1-3-1s-6.664 2.133-5.25 6.375c1 3 3.844 1.594 4.25-1.375c.407-2.973 4-4 4-4" />
      <path fill="#F9CA55" d="M17 26s-1-1-3-1s-4.885 1.53-5 6c-.094 3.656 4.031 2 4-1c-.031-3 4-4 4-4" />
      <path
        fill="#EF9645"
        d="M5 27c0 3.297.457 5.286 2.428 4.947c3.269-.562 2.028-4.614 4.889-5.754c2.077-.827 5.101-.63 8.02 1.103C22.26 28.438 21 24 19 23s-8 0-9 0s-5 4-5 4"
      />
      <path
        fill="#F9CA55"
        d="M4.842 27.174C3.251 29.839 4.219 32.594 7 32c2.691-.574 1.343-4.07 4-6c1.489-1.082 4.698-1.445 6.698-.445S20 24 18 23s-8.54-.025-9.538.037c-1.909.119-3.62 4.137-3.62 4.137"
      />
      <path
        fill="#3B88C3"
        d="M9.418 29.114a1.87 1.87 0 0 1-2.639.18l-.196-.171a1.869 1.869 0 0 1-.18-2.638L28.926.668a1.87 1.87 0 0 1 2.639-.18l.195.171a1.87 1.87 0 0 1 .181 2.638z"
      />
      <path
        fill="#3B88C3"
        d="M10.49 27.886c-2.36 2.705-8.313 8.009-9.067 7.352c-.753-.657 3.693-7.275 6.053-9.981c2.36-2.706 1.661-.542 2.493.185c.832.726 2.881-.26.521 2.444"
      />
      <path
        fill="#EF9645"
        d="M6.672 25.026c0 1 2.421 1.915 3.421.915s3.341-2.228 6.419-.941C23.716 28.01 21 24 18 23s-8 0-9 0s-2.328 2.026-2.328 2.026"
      />
      <path
        fill="#FFDC5D"
      ...
      <path
        fill="#EF9645"
        d="M13.196 16.275c1.064-.388 5.702-1.232 8.115-2.068c1.949-.676 3.659.636-.04 2.028c-3.57 1.343-7.279 1.233-9.984 2.307c-1.023.406-1.91-.875 1.909-2.267"
      />
      <path
        fill="#3B88C3"
        d="M22.487 8.023s-5.928 6.795-8.446 9.661c2.254-.926 4.271-.75 6.198-1.884c1.927-1.133 2.806-2.342 5.73-5.695c1.086-1.244-3.482-2.082-3.482-2.082"
      />
    </svg>
  );
};
...
const MessageIcon = () => {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24">
      <path
        className="fill-chablis-500"
        d="M12 2C6.486 2 2 5.589 2 10c0 2.907 1.897 5.515 5 6.934V22l5.34-4.005C17.697 17.853 22 14.32 22 10c0-4.411-4.486-8-10-8m2 11H7v-2h7zm3-4H7V7h10z"
      />
    </svg>
  );
};
  ...
  return (
    <svg className="h-4 w-4" viewBox="0 0 64 64">
      <path
        ...
        className="fill-solitude-600 transition-colors duration-300 group-hover:fill-solitude-700 dark:fill-solitude-500 dark:group-hover:fill-solitude-400"
      />
    </svg>
  );
};
...
const MoonIcon = () => {
  return (
    <svg className="h-4 w-4" viewBox="0 0 15 15">
      <path
...
const CalendarIcon = () => {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 fill-solitude-500">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
...
const ViewsIcon = () => {
  return (
    <svg className="h-4 w-4 fill-chablis-500" viewBox="0 0 24 24">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
...
const DownIcon = () => {
  return (
    <svg className="h-5 w-5 stroke-slate-700 dark:stroke-slate-300" viewBox="-0.5 0 25 25" fill="none">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
        <path
