...
export default function Blog() {
  ...
  return (
    <section className="mx-2 xl:mx-0 xl:w-[1280px]">
      <h1 className="mb-4 text-xl font-semibold tracking-tight text-solitude-950 underline decoration-slate-200 decoration-4 underline-offset-4 dark:text-solitude-100 dark:decoration-slate-700 lg:mb-6 lg:text-2xl">
        Writing
      </h1>
