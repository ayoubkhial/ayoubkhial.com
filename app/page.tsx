...
const HeroSection = () => {
  return (
    <>
      <section className="mx-2 rounded-lg bg-solitude-50 lg:flex lg:items-center lg:gap-4 xl:mx-0 xl:w-[1280px]">
        <div className="p-4 lg:w-2/3 lg:p-8 lg:pr-0 xl:w-3/4">
          <div className="mb-6 md:mb-0">
            <p className="mb-1 font-mono text-xs font-extrabold tracking-wide text-solitude-900  lg:mb-2 lg:text-sm">Hello, my name is</p>
            <h1 className="mb-2 text-2xl font-bold text-solitude-950 sm:text-3xl lg:mb-4 xl:text-4xl">Ayoub Khial</h1>
            <p className="mb-3 text-sm font-medium tracking-tight text-solitude-900  lg:mb-6 lg:text-base">
              Welcome to my digital space, where I spill the beans on everything related to web development.
            </p>
            <p className="text-sm leading-relaxed text-solitude-900 lg:text-base lg:leading-7">
          ...
          <div className="flex flex-wrap items-center gap-6 font-mono text-xs font-bold md:hidden">
            ...
            >
              <LinkedInIcon />
              <span className="hidden text-solitude-700 underline decoration-solitude-200 decoration-2 underline-offset-2 transition duration-300 hover:decoration-solitude-400  sm:inline-block">
                LinkedIn
              </span>
            </Link>
            <Link
            ...
            >
              <MessageIcon />
              <span className="hidden text-chablis-600 underline decoration-chablis-200 decoration-2 underline-offset-2 transition duration-300 hover:decoration-chablis-400  sm:inline-block">
                Email
              </span>
            </Link>
            <Link href="/resume.pdf" download={true} className="flex items-center gap-2" aria-label="Resume">
              <LinkIcon />
              <span className="hidden text-madang-600 underline decoration-madang-200 decoration-2 underline-offset-2 transition duration-300 hover:decoration-madang-400 sm:inline-block">
                Resume
              </span>
            </Link>
          </div>
    ...
    <>
      <section className="mx-2 xl:mx-0 xl:w-[1280px]">
        <div className="mb-4 flex gap-2 lg:mb-6 lg:gap-4">
          ...
          <Link
            href="/blog"
            className="self-end font-mono text-xs font-bold tracking-tight text-solitude-900 underline decoration-solitude-200 decoration-2 underline-offset-2 transition duration-300 hover:decoration-solitude-400 "
          >
            See all
          </Link>
        </div>
...
const NewsletterSection = () => {
  return (
    <>
      <section className="shadow-smsm:p-6 flex w-[98%] items-center justify-between rounded-lg border border-slate-200 bg-white p-4 lg:p-8 xl:mx-0 xl:w-[1280px]">
        <div>
