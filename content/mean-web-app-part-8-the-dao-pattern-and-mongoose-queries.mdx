...
Unless you have a reason not to, you should always save your documents using the `Document::save`
method due to its validation and middleware support. **(More on middleware in a later article)**
</Callout>
