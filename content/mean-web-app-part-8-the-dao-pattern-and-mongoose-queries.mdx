...
keywords: "express.js(slate),node.js(green),mongoose(red),typescript(blue)"
series: "Build a MEAN web app"
part: 8
---

<Callout>
The complete source code up to this point can be found in [this repository](https://github.com/ayoubkhial/bugsight-app/tree/part-7).
</Callout>
...
<Image alt={'The Data Access Object Pattern'} filename={'mean-web-app-part-8-the-dao-pattern-and-mongoose-queries/1.webp'} />
...
<Image alt={'Mongo Compass Collection Indexes'} filename={'mean-web-app-part-8-the-dao-pattern-and-mongoose-queries/2.webp'} />
...
These are the most used options. Please check [MongoDB Documentation](https://www.mongodb.com/docs/manual/reference/collation/) for more options and details.
...
You can find the complete code source in [this repository](https://github.com/ayoubkhial/bugsight-app/tree/part-8); feel free to give it a star ⭐️.
