...
<Image alt={'Automatic switch light/dark modes in VSCode'} filename={'23-stunning-vscode-themes-for-any-lighting/1.avif'} adaptive={false} />

If you want more control to switch modes, a handy extension called [Toggle Light/Dark Theme](https://marketplace.visualstudio.com/items?itemName=danielgjackson.auto-dark-mode-windows) provides a quick toggle between light/dark themes in VS Code using our already-defined settings.

<Image alt={'Toggle Light/Dark Theme extension'} filename={'23-stunning-vscode-themes-for-any-lighting/2.avif'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=teabyii.ayu) - [VSCode web](https://vscode.dev/theme/teabyii.ayu/Ayu%20Dark)

<Image alt={'Ayu VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/1.webp'} adaptive={false} priority={true} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=BeardedBear.beardedtheme) - [VSCode web](https://vscode.dev/theme/beardedbear.beardedtheme/Bearded%20Theme%20Light)

<Image alt={'Bearded VSCode theme'} filename={'23-stunning-vscode-themes-for-any-lighting/2.webp'} adaptive={false} priority={true} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=giovanicascaes.calm-days-sober-nights-theme-vscode) - [VSCode web](https://vscode.dev/theme/giovanicascaes.calm-days-sober-nights-theme-vscode/Calm%20Days%2C%20Sober%20Nights%20-%20Night%20(no%20bold%20style))

<Image alt={'Calm Days, Sober Nights VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/3.webp'} adaptive={false} priority={true} />

### Catppuccin for VSCode
Catppuccin is a minimal and aesthetic dark & light theme, designed to be pleasant and relaxing to your eyes, reducing the fatigue you could get from long coding sessions. It's notable for its warm, 
balanced color palette.

[Marketplace page](https://marketplace.visualstudio.com/items?itemName=Catppuccin.catppuccin-vsc-icons) - [VSCode web](https://vscode.dev/theme/catppuccin.catppuccin-vsc/Catppuccin%20Latte)

<Image alt={'Catppuccin VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/4.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=Equinusocio.vsc-community-material-theme) - [VSCode web](https://vscode.dev/theme/equinusocio.vsc-community-material-theme/Community%20Material%20Theme%20Darker)

<Image alt={'Community Material VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/5.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=fisheva.eva-theme) - [VSCode web](https://vscode.dev/theme/fisheva.eva-theme/Eva%20Light)

<Image alt={'Eva VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/6.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=sainnhe.everforest) - [VSCode web](https://vscode.dev/theme/sainnhe.everforest/Everforest%20Dark)

<Image alt={'Everforest VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/7.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=lkytal.FlatUI) - [VSCode web](https://vscode.dev/theme/lkytal.flatui/FlatUI%20Dark)

<Image alt={'Flat UI VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/8.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=GitHub.github-vscode-theme) - [VSCode web](https://vscode.dev/theme/github.github-vscode-theme/GitHub%20Light)

<Image alt={'GitHub VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/9.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=pabue.linear-theme) - [VSCode web](https://vscode.dev/theme/pabue.linear-theme/Linear%20Theme%20-%20Dark)

<Image alt={'Linear VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/10.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=Equinusocio.vsc-material-theme) - [VSCode web](https://vscode.dev/theme/equinusocio.vsc-material-theme/Material%20Theme)

<Image alt={'Material VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/11.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=miguelsolorio.min-theme) - [VSCode web](https://vscode.dev/theme/miguelsolorio.min-theme/Min%20Dark)

<Image alt={'Min VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/12.webp'} adaptive={false} />

### Minimal Wave
This theme has a minimalist design with a touch of Synthwave style. It features two themes - Dark Floral and Light Floral.

[Marketplace page](https://marketplace.visualstudio.com/items?itemName=miguelsolorio.min-theme) - [VSCode web](https://vscode.dev/theme/annalifatou.minimal-wave/Minimal%20Wave%20-%20Dark%20Floral)

<Image alt={'Minimal Wave VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/13.webp'} adaptive={false} />

### Moxer Theme
From the creators of Material Theme, Mower is a theme designed to elevate your DX to new heights.

[Marketplace page](https://marketplace.visualstudio.com/items?itemName=Equinusocio.moxer-theme) - [VSCode web](https://vscode.dev/theme/equinusocio.moxer-theme/Moxer%20Light)

<Image alt={'Moxer VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/14.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=sdras.night-owl) - [VSCode web](https://vscode.dev/theme/sdras.night-owl/Night%20Owl%20(No%20Italics))

<Image alt={'Night Owl VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/15.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=liwei.relax-eyes-theme) - [VSCode web](https://vscode.dev/theme/liwei.relax-eyes-theme/Relax%20Light)

<Image alt={'Relax Eyes VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/16.webp'} adaptive={false} />
...
<Image alt={'sema VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/17.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=wicked-labs.wvsc-serendipity) - [VSCode web](https://vscode.dev/theme/wicked-labs.wvsc-serendipity/Serendipity%20Morning)

<Image alt={'Serendipity VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/18.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=felipe-mendes.slack-theme) - [VSCode web](https://vscode.dev/theme/felipe-mendes.slack-theme/Slack%20Theme%20Dark%20Mode)

<Image alt={'Slack VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/19.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=jprestidge.theme-material-theme) - [VSCode web](https://vscode.dev/theme/jprestidge.theme-material-theme/Sublime%20Material%20Theme%20-%20Light)

<Image alt={'Sublime Material VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/20.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=tinaciousdesign.theme-tinaciousdesign) - [VSCode web](https://vscode.dev/theme/tinaciousdesign.theme-tinaciousdesign/Tinacious%20Design%20(Light))

<Image alt={'Tinacious Design VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/21.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=enkia.tokyo-night) - [VSCode web](https://vscode.dev/theme/enkia.tokyo-night/Tokyo%20Night)

<Image alt={'Tokyo Night VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/22.webp'} adaptive={false} />
...
[Marketplace page](https://marketplace.visualstudio.com/items?itemName=johnpapa.winteriscoming) - [VSCode web](https://vscode.dev/theme/johnpapa.winteriscoming/Winter%20is%20Coming%20(Dark%20Black))

<Image alt={'Winter is Coming VSCode Theme'} filename={'23-stunning-vscode-themes-for-any-lighting/23.webp'} adaptive={false} />
