...
keywords: "express.js(slate),node.js(green),mongoose(red)"
series: "Build a MEAN web app"
part: 7
---

<Callout>
The complete source code up to this point can be found in [this repository](https://github.com/ayoubkhial/bugsight-app/tree/part-6).
</Callout>
...
<Callout>
Within this article, we will occasionally utilize queries to highlight some functionalities and behaviors of Mongoose. However, these are merely illustrative. A detailed exploration of queries and DAO will be the subject of our forthcoming article.
</Callout>
...
<Image alt={'SQL Database Normalization'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/1.webp'} />
...
<Image alt={'SQL Normalization VS. NoSQL Denormalization'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/2.webp'} />
...
<Image alt={'MongoDB Embedded Documents'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/3.webp'} />
...
<Image alt={'MongoDB - The Extended Reference Pattern'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/4.webp'} />
...
<Image alt={'Schema Design for Bug Tracking app in MongoDB'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/5.webp'} />
...
<Callout>
In this article, I'll explore various Mongoose features using multiple collections as examples. You can find the complete code in [this Github repository](https://github.com/ayoubkhial/bugsight-app/tree/part-7).
</Callout>
...
<Image alt={'How Mongoose Works'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/6.webp'} />
...
<Image alt={'Visualizing MongoDB Database using MongoDB Shell (mongosh)'} filename={'mean-web-app-part-7-designing-and-modeling-database-with-mongoose/7.webp'} />
...
You can find the complete code source in [this repository](https://github.com/ayoubkhial/bugsight-app/tree/part-7); feel free to give it a star ⭐️.
