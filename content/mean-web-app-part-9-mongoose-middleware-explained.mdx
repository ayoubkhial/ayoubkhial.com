...
<Callout type="INFO">
The complete source code up to this point can be found in [this repository](https://github.com/ayoubkhial/bugsight/tree/part-8).
</Callout>
...
<AdaptiveImage alt={'Mongoose Operation Workflow Diagram'} src={'/img/blog/15/1.webp'} width={768} height={353} />
...
<AdaptiveImage alt={'The Lyfecycle of Mongoose Save Operation'} src={'/img/blog/15/2.webp'} width={768} height={516} />
...
You can find the complete code source in [this repository](https://github.com/ayoubkhial/bugsight/tree/part-9); feel free to give it a star ⭐️.
