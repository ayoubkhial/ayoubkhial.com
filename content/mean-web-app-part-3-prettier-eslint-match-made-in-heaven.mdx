...
keywords: "eslint(violet),prettier(red),typescript(blue),express.js(slate)"
...
<Image alt={'prettier command result'} filename={'mean-web-app-part-3-prettier-eslint-match-made-in-heaven/2.webp'} width={768} height={325} />
