...
<Callout type="INFO">
The complete source code up to this point can be found in [this repository](https://github.com/ayoubkhial/bugsight/tree/part-2).
</Callout>
...
<AdaptiveImage alt={'VSCode prettier settings'} src={'/img/blog/7/1.webp'} width={768} height={509} />
...
<AdaptiveImage alt={'prettier command result'} src={'/img/blog/7/2.webp'} width={768} height={325} />
...
<AdaptiveImage alt={'eslint cli errors example'} src={'/img/blog/7/3.webp'} width={768} height={260} />
...
<AdaptiveImage alt={'eslint VSCode errors example'} src={'/img/blog/7/4.webp'} width={768} height={284} />
