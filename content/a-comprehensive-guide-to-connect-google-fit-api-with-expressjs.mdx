...
keywords: "Express,Node.js,google,google-fit"
published: true
---
...
<AdaptiveImage alt={'Google Fit API Components'} src={'/img/blog/14/1.webp'} width={768} height={340} priority={true} />
...
<AdaptiveImage alt={'Google API Project List'} src={'/img/blog/14/2.webp'} width={768} height={477} />
...
<AdaptiveImage alt={'Google API Project Create Page'} src={'/img/blog/14/3.webp'} width={768} height={450} />
...
<AdaptiveImage alt={'Google Console - Enable Fitness API'} src={'/img/blog/14/4.webp'} width={768} height={394} />
...
<AdaptiveImage alt={'Google Console - OAuth Consent Screen Configuration'} src={'/img/blog/14/5.webp'} width={768} height={462} />
...
<AdaptiveImage alt={'Google Console - Create OAuth Consent Screen'} src={'/img/blog/14/6.webp'} width={768} height={436} />
...
<AdaptiveImage alt={'Google Console - OAuth Consent Screen Information'} src={'/img/blog/14/7.webp'} width={768} height={517} />
...
<AdaptiveImage alt={'Google Console - OAuth Consent Screen Information'} src={'/img/blog/14/8.webp'} width={768} height={437} />
...
<AdaptiveImage alt={'Google Console - OAuth Consent Screen Scopes'} src={'/img/blog/14/9.webp'} width={768} height={374} />

I will search for fitness in the scope list and select all.

<AdaptiveImage alt={'Google Console - OAuth Consent Screen Scope List'} src={'/img/blog/14/10.webp'} width={768} height={383} />
...
<AdaptiveImage alt={'Google Console - OAuth Consent Screen Test Users'} src={'/img/blog/14/11.webp'} width={768} height={456} />
...
<AdaptiveImage alt={'Google Console - Set up Credentials'} src={'/img/blog/14/12.webp'} width={768} height={430} />
...
<AdaptiveImage alt={'Google Console - Create OAuth Client ID'} src={'/img/blog/14/13.webp'} width={768} height={329} />
...
<AdaptiveImage alt={'Google Console - Create OAuth Client ID'} src={'/img/blog/14/14.webp'} width={768} height={354} />
...
<AdaptiveImage alt={'Google Console - Credentials Detail'} src={'/img/blog/14/15.webp'} width={768} height={610} />
...
<AdaptiveImage alt={'Google API - Auth URL'} src={'/img/blog/14/16.webp'} width={768} height={386} />
...
<AdaptiveImage alt={'Google API Consent Screen - Sign in'} src={'/img/blog/14/17.webp'} width={768} height={548} />
...
<AdaptiveImage alt={'Google API Consent Screen - Unverified App'} src={'/img/blog/14/18.webp'} width={768} height={548} />

On the following screen, users are presented with a choice to either grant or deny the requested permissions.

<AdaptiveImage alt={'Google API Consent Screen - Grant/Deny Permissions'} src={'/img/blog/14/19.webp'} width={768} height={620} />
...
<AdaptiveImage alt={'Google API Consent Screen - Successful Redirection'} src={'/img/blog/14/20.webp'} width={768} height={382} />
...
<AdaptiveImage alt={'Get steps count aggregation - Google Fit API'} src={'/img/blog/14/21.webp'} width={768} height={340} />
...
The complete source code for this project is available on this GitHub repository.
