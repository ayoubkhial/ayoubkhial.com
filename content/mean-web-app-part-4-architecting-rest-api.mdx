...
<Image alt={'API testing usin Insomnia'} filename={'mean-web-app-part-4-architecting-rest-api/3.webp'} width={768} height={389} />
...
You can find the complete code source in [this repository](https://github.com/ayoubkhial/bugsight/tree/part-4); feel free to give it a star ⭐️.
